% This is a script file for control
...
xlabel("time [sec]", "Interpreter","latex","FontSize",16);
legend("Actual Linear Velocity","Desired Linear Velocity","location","northeast","Interpreter","latex");
...
xlabel("time [sec]", "Interpreter","latex","FontSize",16);
legend("Actual Angular Velocity","Desired Angular Velocity","location","northeast","Interpreter","latex");
